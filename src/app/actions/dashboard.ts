...
export type Actions =
  CountRequestTodayAction
  | CountRequestLastWeekAction
  | CountRequestTodayByCountryAction
  | AvgByRequestAction
  | RequestByDayAction;
...
export class DashboardAction {
  ...
  constructor(
    ...
    private microserviceAction: MicroserviceAction,
  ...
  countRequestTodayByCountry() {
    this.dashboardService.countRequestTodayByCountry().subscribe((data: Array<Object>) => {
  ...
  avgByRequest(from, to) {
    this.dashboardService.avgByRequest(from, to).subscribe((data: Array<Object>) => {
  ...
  requestByDay(from, to) {
    this.dashboardService.requestByDay(from, to).subscribe((data: Array<Object>) => {
